...
export const StatCreditSchema = z.object({
  ...
  penalty_type: z.string().nullable().optional(),
  jersey_number: z.string().nullable().optional(),
  jersey_number_frame: z.number().nullable().optional(),
...
export const StatPlaySchema = z.object({
  ...
  penalty_on: z.string().nullable().optional(),
  penalty_type: z.string().nullable().optional(),
  penalty_enforcement: z.string().nullable().optional(),
  penalty_timing: z.string().nullable().optional(),
  penalty_yards: z.number().nullable().optional(),
